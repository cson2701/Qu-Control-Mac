...
| In-progress | [#8](https://github.com/cson2701/Qu-Control-Mac/issues/8) | Add support for multiple visible mixer channels with persisted layout | Expand the screen beyond Main LR and save the visible layout locally |
