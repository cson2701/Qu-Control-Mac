...
| In-progress | [#33](https://github.com/cson2701/Qu-Control-Mac/issues/33) | Support custom channel ordering with Main LR pinned last | Persist separate main-window and menu-bar channel orders while keeping Main LR enabled and last |
