...
| Todo | [#18](https://github.com/cson2701/Qu-Control-Mac/issues/18) | Add a debug-only mock connection toggle | Add a debug-only mock toggle and stop discovery immediately when mock mode is enabled |
